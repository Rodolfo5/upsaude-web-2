...
import { BloodGlucoseEntity } from '@/types/entities/biomarkers'

const recommendedValue = 120
...
export function GlycemiaChart({ data }: { data: BloodGlucoseEntity[] }) {
    ...
    return (
      <div className="flex h-[260px] w-full items-center justify-center rounded-2xl bg-gradient-to-b from-white to-[#F8F5FF]">
        <p className="text-sm text-gray-500">
          Nenhum dado de glicemia registrado
        </p>
      </div>
    )
  }
